...
export interface IPlayBackSeekMethodReturnType  {
    eventTime? : string;
}



export class PlayBackSeekMethodReturnType {
    ...
    */
    ...
    constructor (params :IPlayBackSeekMethodReturnType) {
    ...
    toJSON():  IPlayBackSeekMethodReturnType  {
        return {
