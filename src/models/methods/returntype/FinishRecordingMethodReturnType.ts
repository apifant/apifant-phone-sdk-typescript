...
export interface IFinishRecordingMethodReturnType  {
    eventTime? : string;
}



export class FinishRecordingMethodReturnType {
    ...
    */
    ...
    constructor (params :IFinishRecordingMethodReturnType) {
    ...
    toJSON():  IFinishRecordingMethodReturnType  {
        return {
