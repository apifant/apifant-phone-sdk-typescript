...
export interface IPlayUriMethodReturnType  {
    eventTime? : string;
}



export class PlayUriMethodReturnType {
    ...
    */
    ...
    constructor (params :IPlayUriMethodReturnType) {
    ...
    toJSON():  IPlayUriMethodReturnType  {
        return {
