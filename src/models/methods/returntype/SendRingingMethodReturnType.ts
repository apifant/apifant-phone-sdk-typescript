...
export interface ISendRingingMethodReturnType  {
    eventTime? : string;
}



export class SendRingingMethodReturnType {
    ...
    */
    ...
    constructor (params :ISendRingingMethodReturnType) {
    ...
    toJSON():  ISendRingingMethodReturnType  {
        return {
