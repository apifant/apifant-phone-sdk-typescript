...
export interface IStopSendRtpMethodReturnType  {
    eventTime : string;
}



export class StopSendRtpMethodReturnType {
    ...
    */
    ...
    constructor (params :IStopSendRtpMethodReturnType) {
        ValidationManager.validateAttributes(params, ['eventTime'], ['eventTime']);
    ...
    toJSON():  IStopSendRtpMethodReturnType  {
        return {
