...
export interface IDisableDtmfEventsMethodReturnType  {
    eventTime? : string;
}



export class DisableDtmfEventsMethodReturnType {
    ...
    */
    ...
    constructor (params :IDisableDtmfEventsMethodReturnType) {
        ValidationManager.validateAttributes(params, [], ['eventTime']);
    ...
    toJSON():  IDisableDtmfEventsMethodReturnType  {
        return {
