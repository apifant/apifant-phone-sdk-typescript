...
export interface IPlayBackPauseMethodReturnType  {
    eventTime? : string;
}



export class PlayBackPauseMethodReturnType {
    ...
    */
    ...
    constructor (params :IPlayBackPauseMethodReturnType) {
    ...
    toJSON():  IPlayBackPauseMethodReturnType  {
        return {
