...
export interface IRemoveGatewayConfigurationMethodReturnType  {
    eventTime? : string;
    gatewayName? : string;
}
...
export class RemoveGatewayConfigurationMethodReturnType {
    ...
    */
    ...
    constructor (params :IRemoveGatewayConfigurationMethodReturnType) {
    ...
    toJSON():  IRemoveGatewayConfigurationMethodReturnType  {
        return {
