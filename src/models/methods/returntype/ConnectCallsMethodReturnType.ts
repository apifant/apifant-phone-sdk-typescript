...
export interface IConnectCallsMethodReturnType  {
    eventTime? : string;
}



export class ConnectCallsMethodReturnType {
    ...
    */
    ...
    constructor (params :IConnectCallsMethodReturnType) {
    ...
    toJSON():  IConnectCallsMethodReturnType  {
        return {
