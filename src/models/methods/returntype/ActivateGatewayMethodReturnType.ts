...
export interface IActivateGatewayMethodReturnType  {
    eventTime? : string;
    gatewayName? : string;
}
...
export class ActivateGatewayMethodReturnType {
    ...
    */
    ...
    constructor (params :IActivateGatewayMethodReturnType) {
    ...
    toJSON():  IActivateGatewayMethodReturnType  {
        return {
