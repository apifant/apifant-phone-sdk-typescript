...
export interface IStopUriMethodReturnType  {
    eventTime? : string;
}



export class StopUriMethodReturnType {
    ...
    */
    ...
    constructor (params :IStopUriMethodReturnType) {
    ...
    toJSON():  IStopUriMethodReturnType  {
        return {
