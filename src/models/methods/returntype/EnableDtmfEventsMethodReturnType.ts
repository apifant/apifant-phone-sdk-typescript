...
export interface IEnableDtmfEventsMethodReturnType  {
    eventTime? : string;
}



export class EnableDtmfEventsMethodReturnType {
    ...
    */
    ...
    constructor (params :IEnableDtmfEventsMethodReturnType) {
    ...
    toJSON():  IEnableDtmfEventsMethodReturnType  {
        return {
