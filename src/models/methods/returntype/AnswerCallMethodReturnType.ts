...
export interface IAnswerCallMethodReturnType  {
    eventTime? : string;
}



export class AnswerCallMethodReturnType {
    ...
    */
    ...
    constructor (params :IAnswerCallMethodReturnType) {
    ...
    toJSON():  IAnswerCallMethodReturnType  {
        return {
