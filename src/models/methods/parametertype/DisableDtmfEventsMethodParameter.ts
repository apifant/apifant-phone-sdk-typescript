...
export interface IDisableDtmfEventsMethodParameter  {
    callId : string;
}



export class DisableDtmfEventsMethodParameter {

    private  _callId : string;

    constructor (params :IDisableDtmfEventsMethodParameter) {
    ...
    toJSON():  IDisableDtmfEventsMethodParameter  {
        return {
            callId: this._callId
        };
    }
...
class Builder {
    ...
    build() : DisableDtmfEventsMethodParameter {
        return new DisableDtmfEventsMethodParameter({
