...
export interface IActivateGatewayMethodParameter  {
    gatewayName : string;
}



export class ActivateGatewayMethodParameter {
    ...
    */
    ...
    constructor (params :IActivateGatewayMethodParameter) {
    ...
    toJSON():  IActivateGatewayMethodParameter  {
        return {
...
class Builder {
    ...
    build() : ActivateGatewayMethodParameter {
        return new ActivateGatewayMethodParameter({
