...
export interface IPlayBackPauseMethodParameter  {
    callId : string;
    uri : string;
}
...
export class PlayBackPauseMethodParameter {
    ...
    */
    ...
    constructor (params :IPlayBackPauseMethodParameter) {
    ...
    toJSON():  IPlayBackPauseMethodParameter  {
        return {
            callId: this._callId,
            uri: this._uri
        };
...
class Builder {
    ...
    build() : PlayBackPauseMethodParameter {
        return new PlayBackPauseMethodParameter({
