...
export interface IAnswerCallMethodParameter  {
    callId : string;
}



export class AnswerCallMethodParameter {

    private  _callId : string;

    constructor (params :IAnswerCallMethodParameter) {
    ...
    toJSON():  IAnswerCallMethodParameter  {
        return {
            callId: this._callId
        };
    }
...
class Builder {
    ...
    build() : AnswerCallMethodParameter {
        return new AnswerCallMethodParameter({
